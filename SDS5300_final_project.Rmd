...
- whether Fernando Alonso’s finishing positions differ between his tenures at Ferrari and Renault (Alonso has the longest career in this era and is a top performing driver)
...
boxplot(positionOrder ~ constructorRef,
        data = f1_alonso_test,
        main = "Alonso Race Finishing Position at McLaren vs Ferrari",
        ylab = "Finishing Position",
        xlab = ""
          )
```
